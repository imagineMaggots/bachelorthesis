...
\end{verbatim}
ein guter und gut wartbarer C-Code? (Nein, jedoch syntaktisch richtig). Dies ergibt mathematisch die Aussage: $ans=1&c&b&a&n&m&l&k&z&y&x$ (eigentlich: XOR statt AND, @Hendrik: fixe das!!!). Auch wenn solche hohen Vernestungsgrade nicht erstrebenswert sind, sollte die wohlmögliche Existenz dieser nicht missachtet sein. Dies wirft die Frage auf, wo solche Vernestungen schnellmals auch unbemerkt entstehen könnten.

\subparagraph{In Tabellen} ist eine Vernestung zunächst nicht auszuschließen. So kann es schnellmalig der Fall sein, dass man innerhalb einer Zelle einen numerischen Wert mathematisch abbilden möchte, jedoch eine physische Einheit textlich formatiert sehen will. % Veranschaulicht in Anhang XY

\subparagraph{Zwischen verschiedenen Umgebungen} kann (quasi-) beliebig hin- und hergewechselt werden.
