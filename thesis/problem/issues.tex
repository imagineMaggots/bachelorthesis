...
% 0d zu 1d
\subsubsection{Unbekannte Wörter}\phantomsection\label{problems:dim0}% Wort müsste übersetzt werden, aber wird es nicht. Ich bin dumm. Ich komm mir blöd vor. Ich sollte sterben. Dumme Menschen haben kein Leben verdient. Im Sinne der Wissenschaft.
...
\subsubsection{Auszulassende Wörter}\phantomsection\label{problems:dim1}% Meint: Wort wurde nicht als Syntaktisch relevant erkannt; Wort dürfte nicht übersetzt werden
