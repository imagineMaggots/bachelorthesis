...
\lstdefinestyle{texstyle}{
	% Colors
	backgroundcolor=\color{black!20!red!80},
	...
	lineskip=.5em,
	postbreak=\raisebox{1ex}[2ex][0sp]{\tiny\tiny >>}, % \rule[Offset (Y)]{Breite}{Höhe}, hiermit nochmal rumspielen. 
	% Captions
    captionpos=b,                    
    keepspaces=true,    
	% Linenumbers
    numbers=left,      % where to place numbers
    numbersep=5pt,     % distance to the (here) left   
    % Encodings
	inputencoding=utf8,
	extendedchars=true,
	literate=
...
\include{technologies/tek}
\include{solution/desc}
\include{conclusion/ending}
