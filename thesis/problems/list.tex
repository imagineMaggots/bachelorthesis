...
\begin{displaySourceCode}[Problem]{../samples/minimal/document-o}{../samples/minimal/document-e}{../samples/minimal/document-c}
...
%%% In ein Beispiel wie oben zu überführen
