...
%%% Häufige Fehler, im Sinn: Solche Strukturen sind oft Teile von LaTeX Dokumenten
\subsubsection{Fließtexte, Überschriften und Captions}
\subsubsection{Mathematische Typsetzung}
\subsubsection{Tabellen}
\subsubsection{Definitionen und Makros}% Wird: Kommandos beinhalten!
\subsubsection{Umgebungen}% Wird evtl. Überleitung zu mehreren Quelltexten/Paketen
