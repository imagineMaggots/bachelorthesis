...
Aufbauend auf diesen kleinsten Strukturen bahnt sich ein Weg in Richtung größerer Strukturen, welche sich nicht nur in einem einzelnen Quelltext befinden, sondern mitunter auf mehrere Quelltextdateien zugreifen (müssen) und nicht zwingend denselben, einheitlichen syntaktischen Vorgaben unterliegen.% "Quelltextdateien" als Implikation für alle möglichen auxilliaries 

% Meint Kapitel: Spezifische Schwierigkeiten/Probleme/Unlösbarkeiten/Whatev
