% Zu sortierende Beispiele, erkennbare Trennung:

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% An sich für später geeignete Beispiele. Auslagern! %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[h!]
    ...
    \begin{tabularx}{\textwidth}{X X}
        ...
        % Siehe ~/tests/readme.md für namensgebung und "Wo ist die Datei?"
            Erwünscht & \\[-13px] % relative Angabe ggb. echtem Zeilenumbruch (1em) // relativ in dem Sinne: wir gehen von der Position des erwarteten Zeilenumbruches aus und verschieben nach unten oder oben (+ bzw - in der Höhe)
